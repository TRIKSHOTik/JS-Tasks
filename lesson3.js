...
for (let prop in engineers) {
    console.log(`Заработная плата ${prop} состовляет ${engineers[prop]} рублей`);
}
...
let massiv = ['Apple', { name: 'Vitia' }, { age: '17' }, 'Cat', 'Home'];
...
for (let i = 0; i < vegetables.length; i++) {
    array.push({word: vegetables[i], length: vegetables[i].length});  
}
